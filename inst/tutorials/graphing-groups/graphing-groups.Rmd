...
quiz(
  ...
  question("What type of variable is forest location?",
           ...
           answer("nominal"),
           answer("ordinal"),
           answer("catagorical", correct=TRUE, message="Exactly right!"),
...
Chose your favorite graph you made for HWA that you think best presents the results.Then save a copy of the graph (right+click on the graph and then save it or take a screenshot).  then turn your graph in as instructed (paper printout, learning management system, lab notebook, Google Form, or whatever your instructor tells you).  **Make sure to include a proper figure legend below the graph.**
