...
As a reminder, the hemlock data were collected by Smith College Bio 131 students. They measured the diameter and height for eastern hemlock trees at 4 locations in Western Massachusetts. See this link for more information about the data (=metadata): [hemlocks](https://docs.google.com/document/d/1fZHsb6my8DkOV8iTq0Rmr_5acViu8hnBOU5Wxyxt74Q/edit#bookmark=id.l0w21zezf2qy)

If working on a local desktop version where you have installed the `{r4bio}` package, you can get more information by searching for `hemlocks` in the help tab in RStudio or typing `?hemlocks` in the RStudio Console.
