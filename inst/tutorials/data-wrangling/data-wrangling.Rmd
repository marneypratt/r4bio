...
In the last "Getting Data into R" tutorial, we used several functions from base R to look at the structure of data.  Let's try the `glimpse()` function from the `{dplyr}` package to look at the structure of the `hemlocks` dataset. 
