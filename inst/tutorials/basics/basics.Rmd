...
For now, let's just click on this [link to open the sqrt() help documentation](https://stat.ethz.ch/R-manual/R-devel/library/base/html/MathFun.html) in a new browser window and keep this window open for the time being.


## Understanding Help Documents

Note that the help document shows the name of the help page and the package it is from at the top left corner of the help page (the package name is in the {} brackets).
